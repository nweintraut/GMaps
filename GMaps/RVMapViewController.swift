...
class RVMapViewController: UIViewController {
    ...
    @IBAction func clearButtonTouched(button: UIBarButtonItem) {
        if let mapView = self.mapView{
            mapView.clear()
            addDefaultMarkers()
        }
    }
    @IBAction func styleButtonTouched(button: UIBarButtonItem) {
    ...
    @IBAction func didChangeSwitcher(control: UISegmentedControl) {
...
extension RVMapViewController: GMSMapViewDelegate{
    ...
    func mapView(_ mapView: GMSMapView, didTapInfoWindowOf marker: GMSMarker) {
        if marker == self.santaMarker {
            print("In \(self.classForCoder).didTapInfoWIndowOf ... santaMarker")
        } else if marker == self.sydneyMarker {
...
extension RVMapViewController: CLLocationManagerDelegate {
